...
<div class="bg-gray-50 p-6 font-sans">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-3 mb-8">
        ...
        <x-stat-card label="Occupancy Rate" value="94.5%" change="+2.1% from last month" iconBg="bg-orange-500">
            <x-slot:icon>
                <x-heroicon-o-arrow-trending-up class="w-6 h-6 text-white" />
            </x-slot:icon>
        </x-stat-card>
    ...
    <div class="flex gap-4 mb-8">
        ...
        <div class="w-2/5 bg-white rounded-2xl border border-gray-100 p-6">
            <h5 class="text-base font-semibold text-gray-900 mb-4">Property Status</h5>
            <div class="space-y-4">
        ...
        <div class="w-3/4 bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <h5 class="text-base font-semibold text-gray-900 mb-3">Quick Actions</h5>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-8">
        <div class="flex items-center justify-between mb-4">
            ...
            <a href="/admin/properties/create" class="text-sm text-blue-500 font-medium !no-underline">View All</a>
        </div>
        <div class="grid grid-cols-3 gap-2">
            <x-unit-card name="Sunset Villa #15" type="Apartment" beds="2" baths="2" price="2,400" location="Downtown" />
            <x-unit-card name="Oak Street Apt 8A" type="Apartment" beds="1" baths="1" price="1,600" location="Midtown" />
            <x-unit-card name="Garden House 22" type="House" beds="4" baths="3" price="3,800" location="Suburbs" />
        </div>
    </div>
    ...
    <div class="flex gap-4 mb-8">
        ...
        <div class="w-1/2 bg-white rounded-2xl border border-gray-100 p-6">
            <div class="flex items-center justify-between mb-4">
                <h5 class="text-base font-semibold text-gray-900">Recent Payments</h5>
                <a href="/admin/payments/create" class="text-sm text-blue-500 font-medium !no-underline">View All</a>
            </div>
        ...
        <div class="w-1/2 bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <div class="flex items-center justify-between mb-4">
                <h5 class="text-base font-semibold text-gray-900">Maintenance Requests</h5>
                <a href="/admin/maintenance/create" class="text-sm text-blue-500 font-medium !no-underline">View All</a>
            </div>
            <div class="space-y-2">
                <x-maintenance-card title="Leaking faucet" property="Sunset Villa #12" priority="Medium" date="2026-03-30" iconBg="bg-blue-50">
                    <x-slot:icon><x-heroicon-o-clock class="w-5 h-5 text-blue-500" /></x-slot:icon>
                </x-maintenance-card>
                <x-maintenance-card title="Broken AC unit" property="Oak Street Apt 5B" priority="High" date="2026-04-01" iconBg="bg-red-50">
                    <x-slot:icon><x-heroicon-o-information-circle class="w-5 h-5 text-red-500" /></x-slot:icon>
                </x-maintenance-card>
                <x-maintenance-card title="Paint touch-up" property="Garden House 22" priority="Low" date="2026-04-10" iconBg="bg-green-50">
                    <x-slot:icon><x-heroicon-o-paint-brush class="w-5 h-5 text-green-500" /></x-slot:icon>
                </x-maintenance-card>
                <x-maintenance-card title="Paint touch-up" property="Garden House 22" priority="Low" date="2026-04-10" iconBg="bg-green-50">
                    <x-slot:icon><x-heroicon-o-paint-brush class="w-5 h-5 text-green-500" /></x-slot:icon>
                </x-maintenance-card>
   ...
   <div class="bg-white rounded-2xl  shadow-sm border border-gray-100 p-6 mb-8">
    ...
    <div class="flex items-center justify-between mb-4">
        <div class="flex items-center gap-2">
            <x-heroicon-o-document-text class="w-5 h-5 text-gray-700" />
            <h3 class="text-base font-semibold text-gray-900">Upcoming Lease Expirations</h3>
        </div>
        <a href="/admin/leases" class="text-sm text-blue-500 font-medium !no-underline">View All</a>
    </div>

    {{-- Rows --}}
    <div class="space-y-3">
    <x-lease-row name="John Smith"    property="Sunset Villa #12" ends="2026-04-15" status="Expiring Soon" />
    <x-lease-row name="Lisa Anderson" property="Garden Apt 3C"    ends="2026-04-22" status="Expiring Soon" />
    <x-lease-row name="Robert Taylor" property="Hill View #108"   ends="2026-05-10" status="Renewal Pending" />
</div>
